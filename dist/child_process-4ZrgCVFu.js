...
`;
  ...
  async function installPackages(args, ctx, pm = "npm") {
    const { DependencyInstaller } = await import("./index-HkVqijtm.js").then(async (m) => {
      await m.__tla;
      return m;
    }).then((n) => n.af);
...
`;
    ...
    try {
      const { RegistryClient } = await import("./index-HkVqijtm.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.au);
  ...
  spawn = function(command, argsOrOpts, opts) {
    ...
    if (_spawnChildFn) {
      ...
      _spawnChildFn(command, spawnArgs, {
        ...
        var _a, _b;
        unref();
        (_a = child.stdout) == null ? void 0 : _a.push(null);
        (_b = child.stderr) == null ? void 0 : _b.push(null);
        child.exitCode = exitCode;
        child.emit("close", exitCode, null);
        child.emit("exit", exitCode, null);
      }).catch((e) => {
