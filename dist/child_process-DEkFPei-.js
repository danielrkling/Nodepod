...
`;
  ...
  async function installPackages(args, ctx, pm = "npm") {
    const { DependencyInstaller } = await import("./index-BXVQ505a.js").then(async (m) => {
      await m.__tla;
      return m;
    }).then((n) => n.ag);
...
`;
    ...
    try {
      const { RegistryClient } = await import("./index-BXVQ505a.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.av);
